  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Gökhan Turhan</h1>
        <h4>proactive artist & generalist blockchain researcher<br/> experimenting at the longhouse of finance, art, compute<br/> to appreciate the use of knowledge in society.</h4>
      </header>
      <main>
